...
impl InGameClient {
    ...
    pub async fn all_game_data(&self) -> Result<AllGameData, reqwest::Error> {
        let req: AllGameData = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "allgamedata"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn active_player(&self) -> Result<ActivePlayer, reqwest::Error> {
        let req: ActivePlayer = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "activeplayer"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn active_player_name(&self) -> Result<String, reqwest::Error> {
        let req: String = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "activeplayername"))
            .send()
            .await?
            .text()
            .await?;
    ...
    pub async fn active_player_abilities(&self) -> Result<ActivePlayerAbilities, reqwest::Error> {
        let req: ActivePlayerAbilities = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "activeplayerabilities"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn active_player_runes(&self) -> Result<ActivePlayerRunes, reqwest::Error> {
        let req: ActivePlayerRunes = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "activeplayerrunes"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn player_list(&self) -> Result<Vec<Player>, reqwest::Error> {
        let req: Vec<Player> = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "playerlist"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn player_scores(&self, summoner_name: String) -> Result<PlayerScores, reqwest::Error> {
        let req: PlayerScores = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}?summonerName={}", self.port, "playerscores", summoner_name))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn player_summoner_spells(&self, summoner_name: String) -> Result<PlayerSummonerSpells, reqwest::Error> {
        let req: PlayerSummonerSpells = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}?summonerName={}", self.port, "playersummonerspells", summoner_name))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn player_main_runes(&self, summoner_name: String) -> Result<PlayerMainRunes, reqwest::Error> {
        let req: PlayerMainRunes = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}?summonerName={}", self.port, "playermainrunes", summoner_name))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn player_items(&self, summoner_name: String) -> Result<Vec<PlayerItem>, reqwest::Error> {
        let req: Vec<PlayerItem> = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}?summonerName={}", self.port, "playeritems", summoner_name))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn event_data(&self) -> Result<EventData, reqwest::Error> {
        let req: EventData = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "eventdata"))
            .send()
            .await?
            .json()
            .await?;
    ...
    pub async fn game_stats(&self) -> Result<GameStats, reqwest::Error> {
        let req: GameStats = self
            .reqwest_client
            .get(format!("https://127.0.0.1:{}/liveclientdata/{}", self.port, "gamestats"))
            .send()
            .await?
            .json()
            .await?;
